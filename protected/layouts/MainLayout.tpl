            ...
            <div class="container">
                ...
                <div class="navbar navbar-inverse">
                    <div class="navbar-inner">
                        ...
                        <a class="brand" href="#">Mario A. Estrada</a>
                            ...
                            <ul class="nav">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="#">Zikmont</a></li>
                                        <li><a href="#">Kit logistics</a></li>
                                        <li><a href="#">Polea</a></li>
                                        <li class="divider"></li>
                                        <li class="nav-header">Otros</li>                                        
                                        <li><a href="#">Interface MT</a></li>
                                        <li><a href="#">Lazo</a></li>
                                    </ul>
                                </li>
                            </ul>
        ...
        <div id="myCarousel" class="carousel slide">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="themes/Default/img/carousel/slide-01.jpg" alt="">
                    <div class="container">
                ...
                <div class="item">
                    <img src="themes/Default/img/carousel/slide-02.jpg" alt="">
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>CRM Simple!</h1>
                            <p class="lead">Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                ...
                <div class="item">
                    <img src="themes/Default/img/carousel/slide-03.jpg" alt="">
                    <div class="container">
                        <div class="carousel-caption">
                            <h1>Otros</h1>
                            <p class="lead">Polea: administracion documental, Lazo: Backup de directorios. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
